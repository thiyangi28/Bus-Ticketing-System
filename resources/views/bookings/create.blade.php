...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
        <h2 class="text-2xl font-bold text-slate-900 mb-6">New Seat Reservation</h2>
        ...
        <form action="{{ route('bookings.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" min="1" name="seat_number" required placeholder="e.g. 12" value="{{ old('seat_number') }}"
